...
from qordered_astar import RescueFeatureExtractor, QOrderedAStarPlanner
...
def run_q_astar(env, qfunc, use_hybrid: bool = True, q_weight: float = 0.5, classical_weight: float = 1.0):
    ...
    """
    print("\n=== Q-guided A* planning ===")
    planner = QOrderedAStarPlanner(env=env, qfunc=qfunc)
...
def main():
    ...
    try:
        qfunc.load_weights("qlearning_astar/q-order-weights.json")
    ...
    qfunc.save_weights("qlearning_astar/q-order-weights.json")
